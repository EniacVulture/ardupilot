...
#define AP_SERIALMANAGER_DIRECTIONFINDER_BAUD			115200
#define AP_SERIALMANAGER_DIRECTIONFINDER_BUFSIZE_RX 	128
#define AP_SERIALMANAGER_DIRECTIONFINDER_BUFSIZE_TX		128
...
public:
    ...
    enum SerialProtocol {
		...
		SerialProtocol_DirectionFinder = 12			 //Used for directionfinders
    };
